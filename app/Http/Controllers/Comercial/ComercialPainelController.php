...
class ComercialPainelController extends Controller
{
    ...
    public function index()
    {
        ...
        $imcompletos_ind = CompradorIndividual::orWhereNull('nif')->orWhereNull('sobrenome')->orWhereNull('telemovel')->orWhereNull('morada')->where('user_id', 1)->get();
        $imcompletos_col = CompradorColetivo::orWhereNull('telefone')->orWhereNull('telemovel_empresa')->orWhereNull('morada')->orWhereNull('tipo')->orWhereNull('nif')->orWhereNull('contato')->orWhereNull('telemovel')->where('user_id', 1)->get();
